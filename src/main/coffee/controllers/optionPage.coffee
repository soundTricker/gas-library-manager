...
angular.module('LibraryBoxApp')
  .controller 'optionPageCtrl', ['$scope','$rootScope', '$window', '$q', 'notify','$location', (($scope,$rootScope, $window, $q, notify, $location) ->
    ...
    $rootScope.$on "$routeChangeStart", ()-> $rootScope.isViewLoading = on
    $rootScope.$on "$routeChangeSuccess", ()-> $rootScope.isViewLoading = off
    $rootScope.$on "$routeChangeError", ()-> $rootScope.isViewLoading = off
