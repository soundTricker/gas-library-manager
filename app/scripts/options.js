(function() {
  ...
  angular.module('LibraryBoxApp', ['ngSanitize', 'cgNotify', 'ui.bootstrap', 'ui.directives', 'ui.router', 'markdown', "angular-intro", 'angulartics', 'angulartics.google.analytics', 'ui.utils']).constant("apiUrl", "https://gas-library-box.appspot.com/_ah/api").config([
